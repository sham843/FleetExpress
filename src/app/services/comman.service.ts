...
export class CommanService {
  ...
  constructor(private http: HttpClient,
    ...
    tokenExpireRefreshString() {
      let loginObj = "gPbE4f1q7mPr3haepepf467XqGNdC1a226sBsPPk/c4=";
      return loginObj;
    }
    tokenExpireDateTime() {
      let loginObj = "2022-09-07T14:32:37.2544598+05:30";
      return loginObj;
    }
  getHttp(): any {
  ...
  setHttp(type: string, url: string, isHeader: Boolean, obj: any, params: any, baseUrl: any) {
    ...
    if (checkLOginData && this.tokanExpiredFlag == false && isHeader) {
      ...
      let expireAccessToken: any = (Math.round(new Date("2022-09-07T14:32:37.2544598+05:30").getTime() / 1000));
      let tokenExpireDateTime: any = (Math.round(new Date("2022-09-08T07:12:37.2543302+05:30").getTime() / 1000));
