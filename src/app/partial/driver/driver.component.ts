...
export class DriverComponent implements OnInit {
  ...
  getDriverDetails(flag?: any) {
    this.apiCall.setHttp('get', 'get-driver?searchText=' + this.searchDriverForm.value.driverName + '&pageno=' + this.paginationNo + '&rowperPage=' + this.itemsPerPage, true, false, false, 'vehicletrackingBaseUrlApi');
  ...
  blobkUnblockDriver(event: any, drData: any) {
    ...
    this.spinner.show();
    this.apiCall.setHttp('put', 'driver/Block-Unblock-Driver_1', true, param, false, 'vehicletrackingBaseUrlApi');
    // this.subscription = 
  ...
  removeDriverData() {
    ...
    this.spinner.show();
    this.apiCall.setHttp('delete', 'driver/Delete-Driver', true, param, false, 'vehicletrackingBaseUrlApi');
    // this.subscription = 
    this.apiCall.getHttp().subscribe((response: any) => {
      if (response.statusCode == "200") {
        this.spinner.hide();
  ...
  registerDriverSave(formDirective: any) {
    ...
    if (this.driverRegForm.invalid) {
      ...
      debugger
      this.spinner.show();
      this.apiCall.setHttp('post', 'driver/save-update-deriver-details', true, formData, false, 'vehicletrackingBaseUrlApi');
      this.apiCall.getHttp().subscribe((response: any) => {
        if (response.statusCode == "200") {
          this.spinner.hide();
