...
export const PartialLayoutRoutes: Routes = [
  ...
  { path: 'driver', loadChildren: () => import('../../partial/driver/driver.module').then(m => m.DriverModule), data: { title: 'Drivers' }, canActivate: [ExpenseGuard] },
  ...
  { path: 'payment', loadChildren: () => import('../../partial/payment/payment.module').then(m => m.PaymentModule), data: { title: 'Payments' }, canActivate: [ExpenseGuard] },
